...
module.exports = {
  ...
  getSettings: function (path) {
    ...
    var defaults = require('../init/_wplease.json')
    ...
    return new Promise((resolve, reject) => {
      ...
      updateJson(file, obj, function (error) {
        if (error) {
          ...
          console.log('Success:', `add custom theme "${theme}" to the wplease.json`)
          console.log('')
          resolve(true)
        }
      })
  ...
  /**
   * Add the custom plugin to the wplease.json
    ...
    return new Promise((resolve, reject) => {
      ...
      updateJson(file, obj, function (error) {
        if (error) {
          ...
          console.log('Success:', `add custom plugin "${plugin}" to the wplease.json`)
          console.log('')
          resolve(true)
        }
      })
